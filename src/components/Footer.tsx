    ...
    <footer className="bg-primary text-white">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="flex items-center text-gray-300">
                ...
                Av. das Américas, 1000 - Barra da Tijuca, Rio de Janeiro - RJ
              </p>
              <p className="flex items-center text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/5547991508265" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-primary-light mt-8 pt-8 text-center text-gray-300">
          ...
          <p className="mt-2">
            <Link href="/admin/login" className="text-secondary hover:text-secondary-light">
              Área Administrativa
            </Link>
          </p>
        </div>
